class AnagramsController < ApplicationController
  ...
  api :GET, '/anagrams/:word', "Get all the anagrams for this word"
  ...
  api :GET, '/anagrams/get_max_occurring_anagrams', "Returns a list of anagrams with the highest occurrance"
